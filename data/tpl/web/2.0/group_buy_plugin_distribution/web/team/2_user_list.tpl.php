                    ...
                    <div class="widget-body am-fr">
                        ...
                        <div class="am-u-sm-12 ">
                            ...
                            <div class="am-form-group tpl-form-border-form zx-form-input zx-display zx-group">
                                <input type="text" class="am-form-field" name="uname" placeholder="用户昵称" value="<?php  echo $_GPC['uname'];?>" style="border-radius: 4px;width: 240px;">
                            </div>
                        ...
                        <div class="am-scrollable-horizontal am-u-sm-12">
                            <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td><?php  echo $v['frize_money'];?></td>
                                    <td><?php  echo $v['used_mondey'];?></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success btn-xs" onclick="check_state('<?php  echo $v['uid'];?>','<?php  echo $v['id'];?>','<?php  echo $v['check_state'];?>')">
                                            已审核
                                        </a>
                                            <?php  } else { ?>
                                        <a class="btn btn-warning btn-xs" onclick="check_state('<?php  echo $v['uid'];?>','<?php  echo $v['id'];?>','<?php  echo $v['check_state'];?>')">
                                            未审核
                                        </a>
                                            <?php  } ?>

                                        <a class="btn btn-info btn-xs" onclick="money_change('<?php  echo $v['uid'];?>')">资金修改</a>
                                        ...
                                        <?php  } else { ?>
                                        <a class="btn btn-danger btn-xs" href="<?php  echo $this->createWebUrl('unfrez_user',array('uid'=>$v['uid']))?>">解结用户</a>
                                        <?php  } ?>
                                    </td>
                                </tr>
                                <?php  } } ?>
