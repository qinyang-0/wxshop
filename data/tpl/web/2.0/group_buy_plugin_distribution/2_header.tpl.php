		...
		<ul class="sidebar-nav">
			<ul class="sidebar-nav">
				...
				<?php  if(is_array($this->menu_info)) { foreach($this->menu_info as $item) { ?>
					<?php  if($item['display'] == 1) { ?>						<li class="sidebar-nav-link" style="display: flex;align-items: center;">							<a href="<?php  echo $item['url'];?>" <?php  if(strpos($item['do'],$_GPC['do']) !== false || ($item['do'] == 'plug' && $do == 'plsugins')) { ?> class="active" <?php  } ?> style="width:100%;padding:0 10px;">							<?php  if($item['do'] == 'plug') { ?>								<img src="../addons/group_buy/public/plug/plug.png"/>								<span style="margin-left: 4px;"><?php  echo $item['name'];?></span>							<?php  } else { ?>								<i class="<?php  echo $item['icon'];?>" style="width: 15px;height: 15px;text-align: center;margin-right: 5px;"></i>								<?php  echo $item['name'];?>							<?php  } ?>							</a>						</li>
					<!--<li class="sidebar-nav-link" style="display: flex;align-items: center;">
	
						<a href="<?php  echo $item['url'];?>" <?php  if(strpos($item['do'],$_GPC['do']) !== false ) { ?> class="active" <?php  } ?> style="width:100%;padding:0 10px;">
	
						<i class="<?php  echo $item['icon'];?>" style="width: 15px;height: 15px;text-align: center;margin-right: 5px;"></i> <?php  echo $item['name'];?>
