		...
		<div class="row">
			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				...
				<div class="widget am-cf">
					<form action="<?php  echo $this->createWebUrl('plsugins',array('op'=>'market','in'=>'add'))?>" method="post" class="am-form tpl-form-line-form" enctype="multipart/form-data" <?php  if($info['id']) { ?>onsubmit="return false;"<?php  } ?>>
						...
						<div class="widget-body">
							...
							<fieldset>
								...
								<div class="widget-head am-cf">
									<div class="widget-title am-fl"><?php  echo $act_title;?>优惠券</div>
								</div>
