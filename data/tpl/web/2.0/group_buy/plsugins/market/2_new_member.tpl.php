		...
		<div class="row">
			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				...
				<div class="widget am-cf">
					<form action="<?php  echo $this->createWebUrl('plsugins',array('op'=>'market','in'=>'new_member'))?>" method="post" class="am-form tpl-form-line-form" enctype="multipart/form-data">
						...
						<div class="widget-body">
							...
							<fieldset>
								...
								<div class="widget-head am-cf">
									<div class="widget-title am-fl"><?php  echo $act_title;?>新人券</div>
								</div>
								...
								<!--<div class="am-form-group">-->
									...
									<!--</div>-->
								<!--</div>-->
								<?php  if(!empty($new_member_ticket_id) || !empty($new_member_ticket_open) ) { ?>

								<div class="am-form-group">


									<label class="am-u-sm-3 am-u-lg-2 am-form-label"><?php  echo $new_member_ticket_open['name'];?> </label>
									<div class="am-u-sm-9 am-u-end">
										<label class="am-radio-inline am-success">
											<input type="radio"  value="1" name="new_member_ticket_open" data-am-ucheck <?php echo $new_member_ticket_open['value']==1?"checked":''; ?>>
											开启
										</label>
										<label class="am-radio-inline am-success">
											<input type="radio"  value="2" name="new_member_ticket_open"  data-am-ucheck <?php echo $new_member_ticket_open['value']!=1?"checked":''; ?>>
											关闭
										</label>
										<br/>
								...
								<div class="am-form-group">
									<label class="am-u-sm-3 am-u-lg-2 am-form-label"><?php  echo $new_member_ticket_img['name'];?> </label>
									<div class="am-u-sm-9 am-u-end">
										<?php echo tpl_form_field_image(new_member_ticket_img,$new_member_ticket_img['value']?$new_member_ticket_img['value']:"");?>
										<span class="color-9">新人卷弹窗图(推荐尺寸：550*750)</span>
									</div>
								</div>
								<div class="am-form-group">
