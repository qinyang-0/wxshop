...
.icons_4{background-position: 0 -1080px;}
.icons_5{background-position: 0 -300px;}
.icons_6{background-position: 0 -720px;}

.icons_7{background-position: 0 -840px;}
.icons_8{background-position: 0 -600px;}
.icons_9{background-position: 0 -450px;}
.icons_10{background-position: 0 -1050px;}
.icons_11{background-position: 0 -330px;}
.icons_12{background-position: 0 -360px;}
.icons_13{background-position: 0 -480px;}
.icons_14{background-position: 0 -30px;}
.icons_15{background-position: 0 -90px;}
.icons_16{background-position: 0 -870px;}
.icons_17{background-position: 0 -510px;}
...
<div class="tpl-content-wrapper ">
			    ...
			    <div class="page-structure nav_inner subnav" style="float: left;height: 728px;">
						...
						<div class="article_right item_cell_flex" style="float: right;">
							<div class="portable_editor diy_style" style="min-height: 728px;overflow: auto;">
								<div class="editor_inner" id="js_editFormContent">
									<div ng-include="'./../addons/group_buy/template/web/template/temp/edit-basic.html'" editid="00000000" ng-show="focus.id == '00000000'"></div>
								...
								<span class="editor_arrow_wrp js_arrow"></span>
							</div>
						</div>
			  		</div>
			  	</div>	
			  	...
			  	<div class="diy-actions saveBottomBar" style="margin-top: 35px;" >
                    ...
                    <div class="buttonBox diy-actions-submit" style="width: 400px;text-align: center;">
						...
						<!--<span ng-click="linktype()" class="btn btn_primary btn_p20 btn_save">导入已有模板</span>-->
						<span ng-click="saveData('my')" class="btn btn_primary btn_p20 btn_save">新增到我的模板</span>
                    </div>
               </div>
			</div>
			<!--地图-->
				<div class="my_model" map style="display: none">
				    <div class=" ui-draggable " >
				        <div class="dialog" style="border-radius: 15px;">
				            <div class="dialog_hd" style="border-top-left-radius: 15px;border-top-right-radius: 15px;">
				                <a href="javascript:;" class="icon16_opr closed pop_closed model_close" ng-click="draggable()" >关闭</a>
				            </div>
				            <div class="dialog_bd info_box" style="overflow: hidden;">
				            	<div class="font_mini">左键点击所在出现的标记，点击确定即可</div>
				            ...
				            <div class="dialog_ft" style="border-bottom-left-radius: 15px;border-bottom-right-radius: 15px;">
				            	<span class="btn btn_primary btn_input js_btn_p" ng-click="setLocation()">
				            		<button type="button" class="js_btn" style="background: #22c397;">确定</button>
				            	</span>
				                <!--<span class="btn btn_default btn_input js_btn_p model_close" >
				                    <button type="button" class="js_btn" ng-click="draggable()">取消</button>
				                </span>-->
				            </div>
				        </div>
				    </div>
				...
				<!--链接选择(放弃使用)-->
			    <div class="my_model_url" url style="display: none">
				    <div class=" ui-draggable " >
				        <div class="dialog">
				            <div class="dialog_hd">
				                <a href="javascript:;" class="icon16_opr closed pop_closed model_close" ng-click="setmodel()">关闭</a>
				            </div>
				            <div class="dialog_bd info_box item_cell_box" style="overflow: hidden;" >
				                <div class="setlink_l">
				                	<li ng-class="seturltype == 'standard' ? 'setlink_act' : ''" ng-click="pagetype('standard')">单页</li>
				                	<li ng-class="seturltype == 'site' ? 'setlink_act' : ''" ng-click="pagetype('site')">工地列表页面</li>
				                	<li ng-class="seturltype == 'news' ? 'setlink_act' : ''" ng-click="pagetype('news')">文章列表页面</li>
				                	<li ng-class="seturltype == 'case' ? 'setlink_act' : ''" ng-click="pagetype('case')">案列列表页面</li>
				                	<li ng-class="seturltype == 'designer' ? 'setlink_act' : ''" ng-click="pagetype('designer')">设计师页面</li>
				                	<li  ng-class="seturltype == 'other' ? 'setlink_act' : ''" ng-click="pagetype('other')">其他页面</li>
				                </div>
				                <div class="setlink_r diy_style item_cell_flex">
				                	<div ng-show="urltype == 'my' && seturltype == 'standard'" ng-repeat="item in allstandard" class=" setlink_r_item" ng-init="outerIndex = $index">
				                		<div style="width: 100%;">
				                			<li style="width: 85%;float: left;">{{item.name}}</li>
				                			<li class="setlink_r_box item_cell_flex">
				                				<span ng-click="setLink(item.url,item.name)">选择</span>
				                			</li>
				                		</div>
				                		<div ng-show="{{item.info_off}} == '2'" ng-repeat=" list in item.info track by $index">
				                			<div style="width: 100%;padding: 5px 0;">
					                			<li style="width: 85%;float: left;">&nbsp;&nbsp;--{{list.name}}</li>
					                			<li class="setlink_r_box item_cell_flex">
					                				<span ng-click="setLink(list.url,list.name)">选择</span>
					                			</li>
					                		</div>
				                		</div>
				                	</div>
				                	
				                	<div ng-show="urltype == 'my' && seturltype == 'site'" ng-repeat="item in allsite" class="item_cell_box setlink_r_item">
				                		<li>{{item.name}}</li>
				                		<li class="setlink_r_box item_cell_flex">
				                			<span ng-click="setLink(item.url,item.name)">选择</span>
				                		</li>
				                	...
				                	<div ng-show="urltype == 'my' && seturltype == 'case'" ng-repeat="item in allcase" class="item_cell_box setlink_r_item">
				                		<li>{{item.name}}</li>
				                		<li class="setlink_r_box item_cell_flex">
				                			<span ng-click="setLink(item.url,item.name)">选择</span>
				                		</li>
				                	</div>
				                	<div ng-show="urltype == 'my' && seturltype == 'designer'" ng-repeat="item in alldesigner" class="item_cell_box setlink_r_item">
				                		<li>{{item.name}}</li>
				                		<li class="setlink_r_box item_cell_flex">
				                			<span ng-click="setLink(item.url,item.name)">选择</span>
				                		</li>
				            ...
				            <div class="dialog_ft">
				                <span class="btn btn_default btn_input js_btn_p model_close" >
				                    <button type="button" class="js_btn" ng-click="setmodel()">取消</button>
				                </span>
				            </div>
				        </div>
				    </div>
			    ...
			    <!--模板选择-->
				<div class="my_model_tempalte" url style="display: none">
				    <div class=" ui-draggable " >
				        <div class="dialog" style="border-radius: 6px;">
				            <div class="dialog_hd" style="border-top-left-radius: 6px;border-top-right-radius: 6px;">
				                <a href="javascript:;" class="icon16_opr closed pop_closed model_close" ng-click="settempalte()">关闭</a>
				            </div>
				            <div class="dialog_bd info_box item_cell_box">
				                <div class="setlink_r item_cell_flex">
				                	<div ng-show="urltype == 'list'" ng-repeat="item in alltempalte" class="item_cell_box setlink_r_item">
				                		<li>{{item.name}}</li>
				                		<li class="setlink_r_box item_cell_flex">
				                			<span ng-click="setLinks(item.content)">选择</span>
				                		</li>
				                	</div>
				                </div>
				            </div>
				            <!--<div class="dialog_ft" style="border-bottom-left-radius: 6px;border-bottom-right-radius: 6px;">
				                <span class="btn btn_default btn_input js_btn_p model_close" >
				                    <button type="button" class="js_btn" ng-click="settempalte()">取消</button>
				                </span>
				            </div>-->
				        </div>
				    </div>
				...
				<!--分类选择-->
				<div class="my_model_article" style="display: none">
				    <div class="ui-draggable" id="draggables">
				        <div class="dialog" style="border-radius: 15px;">
				            <div class="dialog_hd"style="border-top-left-radius: 15px;border-top-right-radius: 15px;">
				                <a href="javascript:;" class="icon16_opr closed pop_closed model_close" ng-click="cancel_hides()">关闭</a>
				            </div>
				            <div class="dialog_bd info_box item_cell_box" >
				                <div class="setlink_r item_cell_flex">
				                	<div ng-repeat="item in showhides" class="item_cell_box setlink_r_item">
				                		<li>{{item.name}}</li>
				                		<li class="setlink_r_box item_cell_flex">
				                			<span ng-click="article_setLink(item.id,item.name)">选择</span>
				                		</li>
				                	</div>
				                </div>
				                <div class="setlink_r item_cell_flex" ng-show=" urltype == 'lists'">
				                	<div ng-repeat="item in classify" class="item_cell_box setlink_r_item">
				                		<li>{{item.name}}</li>
				                		<li class="setlink_r_box item_cell_flex">
				                			<span ng-click="article_setLink(item.id,item.name)">选择</span>
				                		</li>
				            ...
				            <!--<div class="dialog_ft">
				                <span class="btn btn_default btn_input js_btn_p model_close" >
				                    <button type="button" class="js_btn" ng-click="article_hide()">取消</button>
				                </span>
				            </div>-->
				        </div>
				    </div>
				    <div class="mask ui-draggable" id="draggable" style="display: block;"></div>
				</div>
	...
	<script type="text/javascript">
		...
		var options = <?php  echo json_encode($options)?>;//分类
	...
	<script type="text/javascript" src="<?php  echo MODULE_URL?>template/web/template/js/addarts.js?v=<?php  echo time();?>"></script>
