			...
			<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
				<div class="widget am-cf">
					<div class="widget-head am-cf">
						<div class="widget-title am-cf">会场管理</div>
					</div>
					<div class="widget-body am-fr">
							...
							<form class="toolbar-form" action="./index.php">
								...
								<div class="am-u-sm-12 ">
									<div class="am-form-group tpl-form-border-form zx-form-input zx-display zx-group">
										<input type="text" class="am-form-field" name="keyword" placeholder="专题名称/会场名称" value="<?php  echo $_GPC['keyword'];?>" style="border-radius: 4px;width: 240px;">
									</div>
						...
						<div class="am-u-sm-12 am-fl am-margin-bottom-xs">
							<div class="am-btn-group am-btn-group-xs ">
								<a class="zx-addBut" href="<?php  echo $this->createWebUrl('room',array('op'=>'add','taskid'=>$taskid))?>">
									<i class="fa fa-plus"></i> 添加会场
								</a>
							</div>
						</div>
                        <?php  } ?>
									...
									<?php  if(!empty($list)) { ?>
										<?php  if(is_array($list)) { foreach($list as $row) { ?>
											<tr>
												...
												<td class="am-text-middle">
													<a href="<?php  echo $this->createWebUrl('room',array('op'=>'add','id'=>$row['id'],'taskid'=>$row['taskid']))?>" class="btn btn-info btn-xs">
		...
		$(function() {
			...
			$('.item-delete').click(function(){
				...
				layer.confirm('一但删除将无法恢复，确定删除吗？', {
					...
					$.post("<?php  echo $this->createWebUrl('room',array('op'=>'delete'))?>", {
						id: id,
					}, function(result) {
			...
			$(document).on("click",".setState",function () {
                $.post("<?php  echo $this->createWebUrl('room',array('op'=>'state'))?>", {
