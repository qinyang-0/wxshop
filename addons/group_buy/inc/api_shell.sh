...
# 
api_key="61969d60efa5a93a2aaa1449be87922f952874206" 			#api_key
api_token="447faa0afea5e86581aab332333638781288497482" 	#api_token
url="http://doc.scmmwl.com/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
